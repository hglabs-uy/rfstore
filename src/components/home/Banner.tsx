		...
		<div className='relative bg-gray-900 text-white'>
			...
			<div className='relative z-10 flex flex-col items-center justify-center py-20 px-4 text-center lg:py-40 lg:px-8'>
				<h1 className='text-4xl font-bold mb-4 lg:text-6xl'>
					Potenciando el Futuro de su Empresa con Tecnología de Vanguardia
				</h1>

				<p className='text-lg mb-8 lg:text-2xl'>
					Descubre las ofertas exclusivas y las últimas novedades en tecnología.<br></br> Envíanos tu consulta de stock y nos pondremos en contacto contigo.
				</p>
